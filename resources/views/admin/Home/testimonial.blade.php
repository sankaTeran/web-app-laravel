                ...
                <form method="POST" action="/saveTestimonial" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tm_name" name="tt_name"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tt_description" name="tt_description"
                    ...
                    <tbody>
                        @foreach ($testimonials as $testimonial)
                            <tr>
                                ...
                                <td><img width="100" src="{{ asset('storage/' . $testimonial->image) }}"
                                        alt="" />"</td>
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#slideModal{{ $testimonial->id }}">Edit</button>
                                    <a href="/deleteTestimonial/{{ $testimonial->id }}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>

                            <div class="modal fade" id="slideModal{{ $testimonial->id }}" tabindex="-1"
                                aria-labelledby="slideModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="slideModalLabel">Edit Slide {{ $testimonial->id }}
                                            </h5>
                                        ...
                                        <form method="POST" action="/TestimonialUpdate" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="tm_name" class="form-label">name</label>
                                                    <input type="text" class="form-control" id="tt_name"
                                                        name="tt_name" value="{{ $testimonial->name }}">
                                                </div>

                                                <!-- Profession -->
                                                <div class="mb-3">
                                                    <label for="tt_profession" class="form-label">Profession</label>
                                                    <input type="text" class="form-control" id="tt_profession"
                                                        name="tt_profession" value="{{ $testimonial->profession }}">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tt_description"
                                                        name="tt_description" value="{{ $testimonial->description }}">
                                                </div>

                                                <!-- Image Upload -->
                                                <div class="mb-3">
                                                    <label for="tt_image" class="form-label">Image Upload</label>
                                                    <input type="file" class="form-control" id="tt_image"
                                                        name="tt_image">
                                                </div>
