      ...
      <div class="container py-5">
          <div class="row g-5">
              <div class="col-lg-6 col-xl-5 wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia hic aspernatur unde
                      magnam necessitatibus provident iusto maxime nobis esse eligendi.
                  </p>
                          ...
                          <div class="testimonial-item">
                              ...
                              <div class="testimonial-inner p-4">
                                  <img src="{{ asset('storage/' . $testimonial->image) }}" class="img-fluid"
                                      alt="Testimonial Image" width="150" height="150">
